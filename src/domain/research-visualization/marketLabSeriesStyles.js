...
export const MARKET_LAB_SERIES_STYLES = Object.freeze({
  ...
  deltaUpper: style('GetDelta 上沿', 'price', '#9a4f00', 1, 'dotted'),
  deltaLower: style('GetDelta 下沿', 'price', '#1f5fbf', 1, 'dotted'),
  lpLower: style('LP 区间下沿', 'price', '#7a5cff', 1, 'dashed'),
  lpUpper: style('LP 区间上沿', 'price', '#7a5cff', 1, 'dashed'),
  ...
  bsTheta: style('期权 Theta/日', 'num', '#274f9f'),
  ...
  fundingProxy: style('Funding 估算', 'pct', '#a93226'),
