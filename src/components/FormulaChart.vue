...
<style>
.fc-shell { min-width: 0; min-height: 200px; border: 1px solid var(--line); border-radius: 8px; background: var(--panel); overflow: hidden; }
...
.fc-card { display: grid; gap: 8px; padding: 12px; min-width: 0; }
.fc-kv { display: grid; grid-template-columns: repeat(auto-fit, minmax(70px, 1fr)); gap: 6px; }
.fc-kv div { display: grid; gap: 1px; padding: 6px 8px; border: 1px solid var(--line); border-radius: 5px; background: var(--bg); min-width: 0; }
.fc-kv b { font-size: 0.6rem; color: var(--muted); font-weight: 700; text-transform: uppercase; letter-spacing: 0.03em; }
.fc-kv span { font-size: 0.82rem; font-weight: 800; font-variant-numeric: tabular-nums; overflow-wrap: anywhere; }
...
.fc-vol { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; min-width: 0; }
.fc-vol-main { display: grid; gap: 2px; padding: 10px 8px; border: 1px solid var(--line); border-radius: 8px; background: var(--bg); text-align: center; min-width: 0; overflow-wrap: anywhere; }
