...
function toggle() {
  ...
  if (open.value) setTimeout(() => document.addEventListener('mousedown', onOutside), 0)
}
...
.pc-dot { width: 8px; height: 8px; border-radius: 50%; background: var(--muted); display: inline-block; flex-shrink: 0; }
.tone-blue .pc-dot, .pc-menu .tone-blue .pc-dot { background: #1f5fbf; }
.tone-green .pc-dot, .pc-menu .tone-green .pc-dot { background: #0e7558; }
.tone-orange .pc-dot, .pc-menu .tone-orange .pc-dot { background: #b8860b; }
...
.pc-menu { position: absolute; top: 32px; right: 0; min-width: 160px; padding: 4px; margin: 0; list-style: none; background: var(--panel); border: 1px solid var(--line); border-radius: 8px; box-shadow: 0 6px 18px rgba(0,0,0,0.12); z-index: 30; }
.pc-menu li { display: flex; gap: 6px; align-items: center; padding: 5px 9px; border-radius: 5px; cursor: pointer; font-size: 0.78rem; white-space: nowrap; }
